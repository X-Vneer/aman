...
class FileController extends BaseApiController
{
    ...
    public function uploadFile(Request $request)
    {
        $validator = Validator::make($request->all(), [
            'file' => 'required|file|mimes:jpeg,bmp,png,pdf,xlsx,docx,mp4,avi,flv|max:32024',
        ...
        return $this->sendResponse(true, $data, trans('successfullUpload'), null, 200, $request);
    ...
    public function deleteFile(Request $request)
    {
        ...
        return $this->sendResponse(true, null, trans('successfullDelete'), null, 200, $request);
    }
}
