...
class VideoStoreRequest extends CustomFormRequest
{
    protected $roles = [
        ...
        "video_url.ur" => "required|url|min:1|max:500",
        "video_url.fil" => "required|url|min:1|max:500",
        ...
        "title.fr" => "required|min:1|max:500",
        "title.ur" => "required|min:1|max:500",
        "title.fil" => "required|min:1|max:500",
        "title.id" => "required|min:1|max:500",
        "description" => "array",
