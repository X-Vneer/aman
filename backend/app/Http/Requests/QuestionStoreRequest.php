...
class QuestionStoreRequest extends CustomFormRequest
{
    protected $roles =  [
        ...
        'question.ur' => 'required|min:1|max:1000',
        'question.fil' => 'required|min:1|max:1000',
        ...
        'answers_a.ur' => 'required|min:1|max:1000',
        'answers_a.fil' => 'required|min:1|max:1000',
        ...
        'answers_b.ur' => 'required|min:1|max:1000',
        'answers_b.fil' => 'required|min:1|max:1000',
        ...
        'answers_c.ur' => 'nullable|min:1|max:1000',
        'answers_c.fil' => 'nullable|min:1|max:1000',
        ...
        'answers_d.ur' => 'nullable|min:1|max:1000',
        'answers_d.fil' => 'nullable|min:1|max:1000',
        ...
        'wrong_a.ur' => 'nullable|min:1|max:1000',
        'wrong_a.fil' => 'nullable|min:1|max:1000',
        ...
        'wrong_b.ur' => 'nullable|min:1|max:1000',
        'wrong_b.fil' => 'nullable|min:1|max:1000',
        ...
        'wrong_c.ur' => 'nullable|min:1|max:1000',
        'wrong_c.fil' => 'nullable|min:1|max:1000',
        ...
        'wrong_d.ur' => 'nullable|min:1|max:1000',
        'wrong_d.fil' => 'nullable|min:1|max:1000',
        ...
        'appears_at.ur' => 'required|time_format',
        'appears_at.fil' => 'required|time_format',
