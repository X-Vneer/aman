...
return array(
    ...
    'unique'               => ':attribute مُستخدم مسبقا',
    ...
    'attributes' => [
        ...
        'video_url.ar' => 'رابط الفيديو بالعربية',
        'video_url.en' => 'رابط الفيديو بالإنجليزية',
        'logo' => 'الصورة',
        'price' => 'السعر',
        'title' => 'العنوان',
        ...
        'answers_c' => 'الإجابة ج',
        'answers_d' => 'الإجابة د',
        'wrong_a' => 'الإجابة الخاطئة أ',
        'wrong_b' => 'الإجابة الخاطئة ب',
        'wrong_c' => 'الإجابة الخاطئة ج',
        'wrong_d' => 'الإجابة الخاطئة د',
        ...
        'has_form' => 'يحتوي على نموذج',
        'max_uses' => 'الحد الأقصى للاستخدام',
        'max_customer_uses' => 'الحد الأقصى لاستخدام العميل',
        'type' => 'النوع',
        ...
        // Tawia related
        'symptoms' => 'الأعراض',
        'symptoms.ar' => 'الأعراض بالعربية',
        'symptoms.en' => 'الأعراض بالإنجليزية',
        'appears_at' => 'موعد ظهور السؤال',
    ],
);
