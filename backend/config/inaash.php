...
return [
    ...
    'videos' => [
        ...
        [
            "video_url" => [
                ...
                "ur" => "https://vz-3d93d703-c07.b-cdn.net/bb002b51-3895-44c6-ae7d-c0af9cd7430c/playlist.m3u8",
                "fil" => "https://vz-3d93d703-c07.b-cdn.net/6c463c45-f5f3-4968-8998-1b009f69cf16/playlist.m3u8",
                "id" => "https://vz-3d93d703-c07.b-cdn.net/7f4e167d-28ef-4bed-889a-52272dc6c260/playlist.m3u8",
            ],
            "logo" => env("INAASH_API") . "img/videos/01.jpg",
            "certificate_url" => env("INAASH_API") . "storage/certificate/1/6ed879be539bab894d7ac2219477c11fb9dcf3aa.png",
            "price" => "20",
            "title" => [
                "ar" => "الحالات الصحية الطارئة",
                "en" => "Emergency Health Cases",
                "fr" => "Cas de santé d'urgence",
                "ur" => "ایمرجنسی صحت کے حالات",
                "fil" => "Mga Kasong Pangkalusugan sa Emergency",
            ...
            "description" => [
                ...
                "ur" => "روزمرہ کی زندگی میں صحت کی ہنگامی صورتوں کا جواب دینے کے لیے بنیادی تربیت فراہم کرتا ہے، جس میں خون بہنے والی چوٹیں، گرمی کا دباؤ، سانس کی نالی کی رکاوٹ، ذیابیطس کا کوما اور بلڈ پریشر کی حالتیں شامل ہیں۔",
                "fil" => "Nagbibigay ng pangunahing pagsasanay sa pagtugon sa mga sitwasyong pangkalusugan sa emergency sa pang-araw-araw na buhay, kabilang ang mga sugat na may pagdurugo, heat stress, pagbara ng daanan ng hangin, diabetic coma, at mga kondisyon ng presyon ng dugo.",
        ...
        [
            "video_url" => [
                ...
                "ur" => "https://vz-c23c20ef-869.b-cdn.net/0babd30a-9472-4d57-a9b2-a08810a724b1/playlist.m3u8",
                "fil" => "https://vz-c23c20ef-869.b-cdn.net/9d9521b9-928f-409f-ab3d-5faeee78d8b4/playlist.m3u8",
                "id" => "https://vz-c23c20ef-869.b-cdn.net/05e477b7-3d3d-467a-af03-2779baf2d96e/playlist.m3u8",
            ],
            "logo" => env("INAASH_API") . "img/videos/02.jpeg",
            "certificate_url" => env("INAASH_API") . "storage/certificate/2/9d79afeca165070486953dcc1c3074377d91bc28.png",
            "price" => "20",
            "title" => [
                "ar" => "الحالات الرياضية الطارئة",
                "en" => "Emergency Sports Cases",
                "fr" => "Cas d'urgence sportive",
                "ur" => "ایمرجنسی اسپورٹس کے کیسز",
                "fil" => "Mga Kasong Pang-emergency sa Palakasan",
            ...
            "description" => [
                ...
                "ur" => "روزمرہ کی زندگی میں کھیلوں کی ہنگامی صورتوں کا جواب دینے کے لیے بنیادی تربیت فراہم کرتا ہے، جس میں دماغی جھٹکا، زبان کا نگلنا - زبان کے پٹھوں کا آرام، دل کا دورہ اور ہڈیوں کے ٹوٹنے کی چوٹیں شامل ہیں۔",
                "fil" => "Nagbibigay ng pangunahing pagsasanay sa pagtugon sa mga sitwasyong pang-emergency sa palakasan sa pang-araw-araw na buhay, kabilang ang mga pinsala na nagdudulot ng pag-uga ng utak, paglunok ng dila - Pagpapahinga ng kalamnan ng dila, paghinto ng tibok ng puso, at mga bali.",
    ...
    'FAQs' =>  [
        [
            "title" => [
                ...
                "en" => "What is an Inaash program?",
                "fr" => "Qu'est-ce qu'un programme d'Inaash ?",
                "ur" => "ایناش پروگرام کیا ہے؟",
                "fil" => "Ano ang programang Inaash?",
                "id" => "Apa itu program Inaash?"
            ],
            "description" => [
                ...
                "ur" => "یہ ایک انٹرایکٹو آگاہی تربیتی پروگرام ہے جو صحت اور کھیلوں کی ہنگامی چوٹوں کے بارے میں آگاہی فراہم کرتا ہے اور ان سے نمٹنے کے صحیح طریقوں کو سکھاتا ہے۔",
                "fil" => "Ito ay isang interactive na programang pangkamalayan para turuan at pataasin ang kaalaman tungkol sa mga emerhensiyang pangkalusugan at pang-sports at ang tamang paraan upang harapin ang mga ito.",
        ...
        [
            "title" => [
                ...
                "ur" => "نشانہ بنانے والے افراد کون ہیں؟",
                "fil" => "Sino ang mga target na kategorya?",
            ...
            "description" => [
                ...
                "ur" => "یہ پروگرام معاشرے کے تمام افراد کے لیے ہے جن کی عمر 8 سال سے شروع ہوتی ہے۔",
                "fil" => "Ang programa ay nakadirekta sa lahat ng miyembro ng lipunan simula sa edad na 8 taon.",
        ...
        [
            "title" => [
                ...
                "ur" => "کیا رجسٹریشن کے لئے کوئی شرائط ہیں؟",
                "fil" => "Mayroon bang anumang kinakailangan para magparehistro?",
            ...
            "description" => [
                ...
                "ur" => "نہیں، کوئی شرائط نہیں ہیں۔",
                "fil" => "Wala, walang kinakailangan.",
        ...
        [
            "title" => [
                ...
                "ur" => "میں کیسے رجسٹر کر سکتا ہوں؟",
                "fil" => "Paano ako makakapagparehistro?",
            ...
            "description" => [
                ...
                "ur" => "سب سے پہلے پورٹل میں اکاؤنٹ بنائیں (رجسٹریشن کریں)، پھر درخواست مکمل کریں، راستہ منتخب کریں (صحت/کھیل) اور الیکٹرانک ادائیگی کا عمل مکمل کریں یا ڈسکاؤنٹ کوڈ استعمال کریں۔",
                "fil" => "Una, lumikha ng account sa portal (rehistrasyon), pagkatapos ay kumpletuhin ang aplikasyon, piliin ang landas (kalusugan/sports), at tapusin ang proseso ng pagbabayad o gumamit ng discount code.",
        ...
        [
            "title" => [
                ...
                "ur" => "میں حاضری کا سرٹیفکیٹ کیسے حاصل کر سکتا ہوں؟",
                "fil" => "Paano ko makukuha ang sertipiko ng pagdalo?",
            ...
            "description" => [
                ...
                "ur" => "میری پروفائل آئیکن میں جا کر سرٹیفکیٹس کے مینو میں جائیں۔",
                "fil" => "Sa pamamagitan ng pag-access sa icon ng Aking Profile at pag-navigate sa menu ng Mga Sertipiko.",
        ...
        [
            "title" => [
                ...
                "ur" => "میں پروگرام میں کیسے شرکت کر سکتا ہوں؟",
                "fil" => "Paano ako makakadalo sa programa?",
            ...
            "description" => [
                ...
                "ur" => "اسمارٹ ڈیوائسز اور کمپیوٹرز کے ذریعے دور سے اور انٹرایکٹو۔",
                "fil" => "Remote at interactive gamit ang mga smart device at computer.",
        ...
        [
            "title" => [
                ...
                "ur" => "کیا سرکاری اور نجی ادارے اپنے ملازمین کے لئے پروگرام کی درخواست دے سکتے ہیں؟",
                "fil" => "Maaari bang humiling ang pampubliko at pribadong mga entidad ng programa para sa kanilang mga empleyado?",
            ...
            "description" => [
                ...
                "ur" => "جی ہاں، ای میل کے ذریعے درخواست بھیج کر: info@inaash.edu.sa",
                "fil" => "Oo, sa pamamagitan ng pagsusumite ng kahilingan sa pamamagitan ng email: info@inaash.edu.sa",
        ...
        [
            "title" => [
                ...
                "ur" => "اگر مجھے مدد کی ضرورت ہو تو میں کس طرح رابطہ کر سکتا ہوں؟",
                "fil" => "Kung kailangan ko ng tulong, paano ako makakakontak?",
            ...
            "description" => [
                ...
                "ur" => "آپ ویب سائٹ پر رابطہ کریں لنک یا ای میل کے ذریعے ہم سے براہ راست رابطہ کر سکتے ہیں: info@inaash.edu.sa",
                "fil" => "Maaari kang makipag-ugnayan sa amin nang direkta sa pamamagitan ng contact us link sa website o sa pamamagitan ng email: info@inaash.edu.sa",
        ...
        [
            "title" => [
                ...
                "ur" => "ادائیگی کا طریقہ کیا ہے؟",
                "fil" => "Ano ang paraan ng pagbabayad?",
            ...
            "description" => [
                ...
                "ur" => "شرکت کے اخراجات کی ادائیگی آن لائن یا ڈسکاؤنٹ کوڈ کے ذریعے کی جا سکتی ہے۔",
                "fil" => "Ang pagbabayad ng bayarin ay maaaring gawin sa pamamagitan ng online payment o paggamit ng discount code.",
        ...
        [
            "title" => [
                ...
                "ur" => "کیا میں تکنیکی مسائل یا انٹرنیٹ کی بندش کے باعث رکاوٹ کے بعد پروگرام مکمل کر سکتا ہوں؟",
                "fil" => "Maaari ko bang tapusin ang programa kung ito ay maantala dahil sa teknikal na isyu o pagkawala ng internet?",
            ...
            "description" => [
                ...
                "ur" => "جی ہاں، آپ پروگرام کو آخری مرحلے سے مکمل کر سکتے ہیں۔ نوٹ: اگر آپ پروگرام کا راستہ تبدیل کرتے ہیں تو دوبارہ فیس ادا کرنی ہوگی۔",
                "fil" => "Oo, maaari mong tapusin ang programa sa huling yugto na natapos. Tandaan: Kung babaguhin mo ang landas ng programa, kakailanganin mong magbayad muli ng bayad.",
        ...
        [
            "title" => [
                ...
                "ur" => "پیش کردہ سرٹیفکیٹ کیا ہے؟",
                "fil" => "Ano ang sertipikasyon na ibinibigay?",
            ...
            "description" => [
                ...
                "ur" => "1- اسپورٹس ایمرجنسیز انٹرایکٹیو آگاہی پروگرام\n2- ہیلتھ ایمرجنسیز انٹرایکٹیو آگاہی پروگرام",
                "fil" => "1- Sports Emergencies Interactive Awareness Program\n2- Health Emergencies Interactive Awareness Program",
        ...
        [
            "title" => [
                ...
                "ur" => "میں سرٹیفکیٹ کب حاصل کر سکتا ہوں؟",
                "fil" => "Kailan ko makukuha ang sertipiko?",
            ...
            "description" => [
                ...
                "ur" => "پروگرام کا راستہ مکمل کرنے اور تشخیصی فارم پُر کرنے کے بعد سرٹیفکیٹ خود بخود ظاہر ہو جاتا ہے۔ ایک الیکٹرانک کاپی ای میل کے ذریعے بھیجی جائے گی۔",
                "fil" => "Awtomatikong lalabas ang sertipiko pagkatapos makumpleto ang landas ng programa at kumpletuhin ang evaluation form. Ang isang elektronikong kopya ay ipapadala sa pamamagitan ng email.",
        ...
        [
            "title" => [
                ...
                "ur" => "میں سرٹیفکیٹ کی تصدیق کیسے کر سکتا ہوں؟",
                "fil" => "Paano ko masusuri ang sertipikasyon?",
            ...
            "description" => [
                ...
                "ur" => "جی ہاں، سرٹیفکیٹ کی تصدیق کے لنک کے ذریعے ویب سائٹ پر یا سرٹیفکیٹ پر موجود بارکوڈ کے ذریعے۔",
                "fil" => "Oo, sa pamamagitan ng link sa pag-verify ng sertipiko sa website o sa pamamagitan ng barcode sa sertipiko.",
    ...
    'scenes' => [
        ...
        [
            "video_id" => "1",
            "logo" => env("INAASH_API") . "img/scenes/1/01.jpeg",
            "title" => [
                "ar" => "الإجهاد الحراري",
                "en" => "Heat exhaustion",
        ...
        [
            "video_id" => "1",
            "logo" => env("INAASH_API") . "img/scenes/1/02.jpeg",
            "title" => [
                "ar" => "النزيف",
                "en" => "Bleeding",
                "fr" => "Saignement",
        ...
        [
            "video_id" => "1",
            "logo" => env("INAASH_API") . "img/scenes/1/03.jpeg",
            "title" => [
                "ar" => "إنسداد مجرى الهواء",
                "en" => "Airway obstruction",
                "fr" => "Obstruction des voies respiratoires",
                "ur" => "سانس کی نالی کا بند ہونا",
                "fil" => "Pagbara ng daanan ng hangin",
        ...
        [
            "video_id" => "1",
            "logo" => env("INAASH_API") . "img/scenes/1/04.jpeg",
            "title" => [
                "ar" => "غيبوبة السكر ",
                "en" => "Diabetic coma",
                "fr" => "Coma diabétique",
        ...
        [
            "video_id" => "1",
            "logo" => env("INAASH_API") . "img/scenes/1/05.jpeg",
            "title" => [
                "ar" => "إرتفاع و إنخفاض ضغط الدم ",
                "en" => "High and low blood pressure",
                "fr" => "Hypertension et hypotension",
                "ur" => "بلند اور کم بلڈ پریشر",
                "fil" => "Mataas at mababang presyon ng dugo",
        ...
        [
            "video_id" => "2",
            "logo" => env("INAASH_API") . "img/scenes/2/01.jpeg",
            "title" => [
                "ar" => "إرتجاج الدماغ ",
                "en" => "Concussion",
                "fr" => "Commotion cérébrale",
                "ur" => "دماغی چوٹ",
                "fil" => "Pagkaalog ng utak",
                "id" => "Kuguran otak"
            ],
            "start_time" => "00:00:00",
            "length" => "00:01:03",
        ...
        [
            "video_id" => "2",
            "logo" => env("INAASH_API") . "img/scenes/2/02.jpeg",
            "title" => [
                "ar" => "الكسور ",
                "en" => "Fracture",
                "fr" => "Fracture",
                "ur" => "ہڈی کا ٹوٹنا",
                "fil" => "Pagkabali ng buto",
                "id" => "Patah"
            ],
            "start_time" => "00:01:04",
            "length" => "00:00:49",
        ...
        [
            "video_id" => "2",
            "logo" => env("INAASH_API") . "img/scenes/2/03.jpeg",
            "title" => [
                "ar" => "بلع اللسان",
                "en" => "Tongue Swallowing",
                "fr" => "Avaler la langue",
                "ur" => "زبان کا نگلنا",
                "fil" => "Paglunok ng dila",
                "id" => "Menelan lidah"
            ],
            "start_time" => "00:01:53",
            "length" => "00:00:52",
        ...
        [
            "video_id" => "2",
            "logo" => env("INAASH_API") . "img/scenes/2/04.jpeg",
            "title" => [
                "ar" => "توقف عضلة القلب",
                "en" => "Cardiac arrest",
                "fr" => "Arrêt cardiaque",
                "ur" => "دل کی بندش",
                "fil" => "Pag-aresto sa puso",
                "id" => "Henti jantung"
            ],
            "start_time" => "00:02:51",
            "length" => "00:00:59",
    ...
    'questions' => [
        ...
        [
            ...
            "question" => [
                ...
                "fil" => "Mukhang may heat exhaustion ang pilgrim dahil sa sunstroke. Ano ang gagawin mo?",
                "fr" => "Il semble que le pèlerin souffre d'épuisement dû à une insolation. Que ferez-vous?",
                "ur" => "ایسا لگتا ہے کہ حاجی دھوپ کی شدت سے گرمی کا شکار ہوا ہے۔ آپ کیا کریں گے؟",
            ...
            "answers_a" => [
                ...
                "fil" => "Ilipat ang pilgrim sa lilim at palamigin ang kanyang balat gamit ang malamig na tubig.",
                "fr" => "Déplacez le pèlerin dans un endroit ombragé et refroidissez sa peau avec de l'eau froide.",
                "ur" => "حاجی کو سایہ دار جگہ پر لے جائیں اور اس کی جلد کو ٹھنڈے پانی سے ٹھنڈا کریں۔",
            ...
            "answers_b" => [
                ...
                "fil" => "Spray ng napakalamig na tubig o yelo direkta sa katawan ng pilgrim upang mabilis siyang lumamig.",
                "fr" => "Vaporisez de l'eau très froide ou de la glace directement sur le corps du pèlerin pour le refroidir rapidement.",
                "ur" => "حاجی کے جسم پر بہت ٹھنڈا پانی یا برف چھڑکیں تاکہ اسے فوراً ٹھنڈا کیا جا سکے۔",
            ...
            "wrong_b" => [
                ...
                "fil" => "Maaari nitong bawasan ang kakayahan ng katawan na mawala ang init, na nagdaragdag ng panganib ng heat shock o muscle cramps. Ang tamang sagot ay ilipat ang pilgrim sa lilim at palamigin gamit ang malamig na tubig.",
                ...
                "ur" => "جسم کی گرمی نکالنے کی صلاحیت کم ہونے سے حرارتی جھٹکا یا پٹھوں میں کھچاؤ کا خطرہ بڑھ جاتا ہے۔ صحیح انتخاب حاجی کو سایہ دار جگہ منتقل کرنا اور ٹھنڈے پانی سے جلد کو ٹھنڈا کرنا ہے۔",
            ...
            "answers_c" => [
                ...
                "fil" => "Iwan ang pilgrim sa ilalim ng araw at subukang bigyan siya ng mainit na inumin upang magpawis.",
                "fr" => "Laissez le pèlerin au soleil et essayez de lui donner une boisson chaude pour induire la transpiration.",
                "ur" => "حاجی کو دھوپ میں چھوڑ دیں اور اسے پسینہ لانے کے لیے گرم مشروب دینے کی کوشش کریں۔",
            ...
            "wrong_c" => [
                ...
                "fil" => "Ang pagtaas ng temperatura ng katawan ay maaaring humantong sa isang kritikal na yugto ng heatstroke na maaaring magdulot ng pagkawala ng malay o kamatayan. Ang tamang sagot ay ilipat ang pilgrim sa lilim at palamigin gamit ang malamig na tubig.",
                ...
                "ur" => "جسم کا درجہ حرارت بڑھنے سے حرارت کا جھٹکا لگنے کا خطرہ بڑھ سکتا ہے جو بے ہوشی یا موت کا سبب بن سکتا ہے۔ صحیح طریقہ حاجی کو سایہ دار جگہ پر لے جانا اور ٹھنڈے پانی سے اس کی جلد کو ٹھنڈا کرنا ہے۔",
            ...
            [
                "ar" => [
                    'answer_a' => "",
                    'answer_b' => env("INAASH_API") . "vo/1/1/Arabic/b.mp3",
                    'answer_c' => env("INAASH_API") . "vo/1/1/Arabic/c.mp3",
                    'answer_d' => "",
                ],
                "en" => [
                    'answer_a' => "",
                    'answer_b' => env("INAASH_API") . "vo/1/1/English/b.mp3",
                    'answer_c' => env("INAASH_API") . "vo/1/1/English/c.mp3",
                    'answer_d' => "",
                ],
                "fr" => [
                    'answer_a' => "",
                    'answer_b' => env("INAASH_API") . "vo/1/1/French/b.mp3",
                    'answer_c' => env("INAASH_API") . "vo/1/1/French/c.mp3",
                    'answer_d' => "",
                ],
                "fil" => [
                    'answer_a' => "",
                    'answer_b' => env("INAASH_API") . "vo/1/1/Filipino/b.mp3",
                    'answer_c' => env("INAASH_API") . "vo/1/1/Filipino/c.mp3",
                    'answer_d' => "",
                ],
                "ur" => [
                    'answer_a' => "",
                    'answer_b' => env("INAASH_API") . "vo/1/1/Urdu/b.mp3",
                    'answer_c' => env("INAASH_API") . "vo/1/1/Urdu/c.mp3",
                    'answer_d' => "",
                ],
                "id" => [
                    'answer_a' => "",
                    'answer_b' => env("INAASH_API") . "vo/1/1/Indonesian/b.mp3",
                    'answer_c' => env("INAASH_API") . "vo/1/1/Indonesian/c.mp3",
                    'answer_d' => ""
                ],
            ],
        ],
        [
            ...
            "question" => [
                ...
                "fil" => "Dumudugo ang ulo ng bata. Ano ang gagawin mo?",
                "fr" => "Un enfant saigne de la tête. Que feriez-vous?",
                "ur" => "بچہ سر سے خون بہا رہا ہے۔ آپ کیا کریں گے؟",
            ...
            "answers_a" => [
                ...
                "fil" => "Pisil nang diretso sa sugat gamit ang malinis na tela.",
                "fr" => "Appliquez une pression directe sur la plaie avec un chiffon propre.",
                "ur" => "زخم پر براہ راست دباؤ ڈالیں، صاف کپڑا استعمال کریں۔",
            ...
            "answers_b" => [
                ...
                "fil" => "Hugasan nang mabuti ang sugat, sinusubukang alisin ang dumi gamit ang mga daliri.",
                "fr" => "Lavez vigoureusement la plaie en essayant d'enlever la saleté avec les doigts.",
                "ur" => "زخم کو سختی سے دھوئیں، انگلیوں سے گندگی ہٹانے کی کوشش کریں۔",
            ...
            "wrong_b" => [
                ...
                "fil" => "Maaari nitong dagdagan ang panganib ng impeksyon at mas malubhang pinsala. Ang tamang sagot ay pisilin ang sugat gamit ang malinis na tela.",
                ...
                "ur" => "یہ انفیکشن اور گہرے نقصان کے خطرے کو بڑھا سکتا ہے۔ صحیح آپشن زخم پر براہ راست دباؤ ڈالنا ہے، صاف کپڑا استعمال کریں۔",
            ...
            "answers_c" => [
                ...
                "fil" => "Iwanang bukas ang sugat upang huminto ang pagdurugo sa sarili nito.",
                "fr" => "Laissez la plaie exposée pour que le saignement s'arrête tout seul.",
                "ur" => "زخم کو کھلا چھوڑ دیں تاکہ خون بہنا خود بند ہو جائے۔",
            ...
            "wrong_c" => [
                ...
                "fil" => "Maling sagot. Maaari itong humantong sa matinding pagkawala ng dugo, na maaaring magdulot ng shock o pagkawala ng malay. Ang tamang sagot ay pisilin ang sugat gamit ang malinis na tela.",
                ...
                "ur" => "غلط انتخاب۔ یہ زیادہ خون بہنے کا سبب بن سکتا ہے، جو جھٹکے یا بے ہوشی کا باعث بن سکتا ہے۔ صحیح آپشن زخم پر براہ راست دباؤ ڈالنا ہے۔",
            ...
            "wrong_answer_audio_urls" => [
                "ar" => [
                    'answer_a' => "",
                    'answer_b' => env("INAASH_API") . "vo/1/2/Arabic/b.mp3",
                    'answer_c' => env("INAASH_API") . "vo/1/2/Arabic/c.mp3",
                    'answer_d' => "",
                ],
                "en" => [
                    'answer_a' => "",
                    'answer_b' => env("INAASH_API") . "vo/1/2/English/b.mp3",
                    'answer_c' => env("INAASH_API") . "vo/1/2/English/c.mp3",
                    'answer_d' => "",
                ],
                "fr" => [
                    'answer_a' => "",
                    'answer_b' => env("INAASH_API") . "vo/1/2/French/b.mp3",
                    'answer_c' => env("INAASH_API") . "vo/1/2/French/c.mp3",
                    'answer_d' => "",
                ],
                "fil" => [
                    'answer_a' => "",
                    'answer_b' => env("INAASH_API") . "vo/1/2/Filipino/b.mp3",
                    'answer_c' => env("INAASH_API") . "vo/1/2/Filipino/c.mp3",
                    'answer_d' => "",
                ],
                "ur" => [
                    'answer_a' => "",
                    'answer_b' => env("INAASH_API") . "vo/1/2/Urdu/b.mp3",
                    'answer_c' => env("INAASH_API") . "vo/1/2/Urdu/c.mp3",
                    'answer_d' => "",
                ],
                "id" => [
                    'answer_a' => "",
                    'answer_b' => env("INAASH_API") . "vo/1/2/Indonesian/b.mp3",
                    'answer_c' => env("INAASH_API") . "vo/1/2/Indonesian/c.mp3",
                    'answer_d' => "",
                ],
            ],
        ],
        [
            ...
            "question" => [
                ...
                "fil" => "Ang bata ay nasasakal. Ano ang gagawin mo?",
                "fr" => "L'enfant s'étouffe. Que ferez-vous?",
                "ur" => "بچہ گھٹ رہا ہے۔ آپ کیا کریں گے؟",
            ...
            "answers_a" => [
                ...
                "fil" => "Subaybayan ang paghinga ng bata at hikayatin siyang umubo.",
                "fr" => "Surveillez la respiration de l'enfant et encouragez-le à tousser.",
                "ur" => "بچے کی سانس پر نظر رکھیں اور اس کے کھانسی کرنے کی حوصلہ افزائی کریں۔",
            ...
            "answers_b" => [
                ...
                "fil" => "Hampasin nang malakas ang likod ng bata habang nakatayo upang mailabas ang barya.",
                "fr" => "Donnez des coups au dos de l'enfant alors qu'il est debout pour déloger la pièce.",
                "ur" => "جب بچہ کھڑا ہو تو اس کی پیٹھ زور سے ماریں تاکہ سکہ نکل جائے۔",
            ...
            "wrong_b" => [
                ...
                "fil" => "Pinapataas nito ang posibilidad na mas lalong maipit ang barya sa daanan ng hangin, na nangangailangan ng agarang medikal na interbensyon. Ang tamang sagot ay subaybayan ang bata at hikayatin siyang umubo.",
                ...
                "ur" => "یہ سکے کے ہوا کی نالی میں مزید پھنسنے کا خطرہ بڑھا دیتا ہے، جس کے لیے فوری طبی امداد کی ضرورت ہو سکتی ہے۔ صحیح انتخاب بچے کی سانس پر نظر رکھنا اور اسے کھانسی کی حوصلہ افزائی کرنا ہے۔",
            ...
            "answers_c" => [
                ...
                "fil" => "Subukan na ipasok ang iyong mga daliri sa bibig ng bata upang alisin ang barya.",
                "fr" => "Essayez de mettre vos doigts dans la bouche de l'enfant pour retirer la pièce.",
                "ur" => "بچے کے منہ میں اپنی انگلیاں ڈالنے کی کوشش کریں تاکہ سکہ نکالا جا سکے۔",
            ...
            "wrong_c" => [
                ...
                "fil" => "Ang pagpasok ng barya nang mas malalim sa daanan ng hangin ay maaaring humantong sa ganap na pagbara at panganib ng pagkasakal. Ang tamang sagot ay subaybayan ang bata at hikayatin siyang umubo.",
                ...
                "ur" => "سکے کو ہوا کی نالی میں مزید دھکیلنے سے مکمل بلاکیج ہو سکتا ہے اور گھٹنے کا خطرہ پیدا ہو سکتا ہے۔ صحیح آپشن بچے کو دیکھنا اور اسے کھانسی پر آمادہ کرنا ہے۔",
            ...
            "wrong_answer_audio_urls" => [
                "ar" => [
                    'answer_a' => "",
                    'answer_b' => env("INAASH_API") . "vo/1/3/Arabic/b.mp3",
                    'answer_c' => env("INAASH_API") . "vo/1/3/Arabic/c.mp3",
                    'answer_d' => "",
                ],
                "en" => [
                    'answer_a' => "",
                    'answer_b' => env("INAASH_API") . "vo/1/3/English/b.mp3",
                    'answer_c' => env("INAASH_API") . "vo/1/3/English/c.mp3",
                    'answer_d' => "",
                ],
                "fr" => [
                    'answer_a' => "",
                    'answer_b' => env("INAASH_API") . "vo/1/3/French/b.mp3",
                    'answer_c' => env("INAASH_API") . "vo/1/3/French/c.mp3",
                    'answer_d' => "",
                ],
                "fil" => [
                    'answer_a' => "",
                    'answer_b' => env("INAASH_API") . "vo/1/3/Filipino/b.mp3",
                    'answer_c' => env("INAASH_API") . "vo/1/3/Filipino/c.mp3",
                    'answer_d' => "",
                ],
                "ur" => [
                    'answer_a' => "",
                    'answer_b' => env("INAASH_API") . "vo/1/3/Urdu/b.mp3",
                    'answer_c' => env("INAASH_API") . "vo/1/3/Urdu/c.mp3",
                    'answer_d' => "",
                ],
                "id" => [
                    'answer_a' => "",
                    'answer_b' => env("INAASH_API") . "vo/1/3/Indonesian/b.mp3",
                    'answer_c' => env("INAASH_API") . "vo/1/3/Indonesian/c.mp3",
                    'answer_d' => "",
                ],
            ],
        ],
        [
            ...
            "question" => [
                ...
                "fil" => "Ang isang katrabaho ay nakakaranas ng mga palatandaan ng pagkahilo, pagkalito, at pagkawala ng malay. Mukhang nasa diabetic coma siya dahil sa mababang asukal sa dugo Ano ang gagawin mo?",
                ...
                "ur" => "ایک ساتھی کارکن چکر آنا، الجھن، اور ہوش کھونے کی علامات کا سامنا کر رہا ہے۔ ایسا لگتا ہے کہ وہ کم بلڈ شوگر کی وجہ سے ذیابیطس کے کوما میں ہے آپ کیا کریں گے؟",
            ...
            "answers_a" => [
                ...
                "fil" => "Siguraduhing regular ang paghinga at tibok ng puso at bigyan ng solusyon ng asukal ang nasugatan",
                ...
                "ur" => "اس بات کو یقینی بنائیں کہ سانس اور دل کی دھڑکن باقاعدہ ہو اور زخمی شخص کو شوگر کا محلول دیں۔",
            ...
            "answers_b" => [
                ...
                "fil" => "Talikan siya ng walang nagmamasid at hintayin siyang makabawi ng kanyang malay.",
                "fr" => "Laissez-le sans surveillance et attendez qu'il reprenne connaissance tout seul.",
                "ur" => "اسے بغیر نگرانی کے چھوڑ دیں اور انتظار کریں کہ وہ خود بخود ہوش میں آ جائے۔",
            ...
            "wrong_b" => [
                ...
                "fil" => "Maaaring mawalan ng pagkakataon ang taong apektado na makatanggap ng first aid sa tamang oras, na maaaring magdulot ng paglala ng kalagayan o kamatayan. Ang tamang hakbang sa kaso ng mababang asukal sa dugo ay siguraduhin na regular ang paghinga at tibok ng puso, kasabay ng pagbibigay ng sugar solution sa taong apektado",
                ...
                "ur" => "متاثرہ شخص بروقت ابتدائی طبی امداد حاصل کرنے کا موقع کھو سکتا ہے، جس کی وجہ سے حالت مزید بگڑ سکتی ہے یا حتیٰ کہ موت واقع ہو سکتی ہے۔ کم شوگر کی صورت میں صحیح اقدام یہ ہے کہ سانس اور دل کی دھڑکن کو باقاعدہ یقینی بنائیں اور متاثرہ شخص کو شوگر کا محلول دیں۔",
            ...
            "answers_c" => [
                ...
                "fil" => "Subukan siyang pugad o ipilit siyang tumayo agad upang matulungan siyang makabawi ng kanyang malay.",
                "fr" => "Essayez de le forcer à s'asseoir ou à se lever immédiatement pour l'aider à retrouver conscience.",
                "ur" => "اسے فوری طور پر بیٹھنے یا کھڑے ہونے پر مجبور کرنے کی کوشش کریں تاکہ اس کی ہوش واپس لانے میں مدد ملے۔",
            ...
            "wrong_c" => [
                ...
                "fil" => "Maaari itong magdulot ng pagbaba ng daloy ng dugo sa utak, na nagpapataas ng panganib ng pagkahulog at karagdagang mga pinsala. Ang tamang hakbang sa kaso ng mababang asukal sa dugo ay siguraduhin na regular ang paghinga at tibok ng puso, kasabay ng pagbibigay ng sugar solution sa taong apektado",
                ...
                "ur" => "اس کی وجہ سے دماغ میں خون کے بہاؤ میں کمی واقع ہو سکتی ہے، جس سے گرنے اور مزید چوٹوں کا خطرہ بڑھ جاتا ہے۔ کم شوگر کی صورت میں صحیح اقدام یہ ہے کہ سانس اور دل کی دھڑکن کو باقاعدہ یقینی بنائیں اور متاثرہ شخص کو شوگر کا محلول دیں۔",
            ...
            "wrong_answer_audio_urls" => [
                "ar" => [
                    'answer_a' => "",
                    'answer_b' => env("INAASH_API") . "vo/1/4/Arabic/b.mp3",
                    'answer_c' => env("INAASH_API") . "vo/1/4/Arabic/c.mp3",
                    'answer_d' => "",
                ],
                "en" => [
                    'answer_a' => "",
                    'answer_b' => env("INAASH_API") . "vo/1/4/English/b.mp3",
                    'answer_c' => env("INAASH_API") . "vo/1/4/English/c.mp3",
                    'answer_d' => "",
                ],
                "fr" => [
                    'answer_a' => "",
                    'answer_b' => env("INAASH_API") . "vo/1/4/French/b.mp3",
                    'answer_c' => env("INAASH_API") . "vo/1/4/French/c.mp3",
                    'answer_d' => "",
                ],
                "fil" => [
                    'answer_a' => "",
                    'answer_b' => env("INAASH_API") . "vo/1/4/Filipino/b.mp3",
                    'answer_c' => env("INAASH_API") . "vo/1/4/Filipino/c.mp3",
                    'answer_d' => "",
                ],
                "ur" => [
                    'answer_a' => "",
                    'answer_b' => env("INAASH_API") . "vo/1/4/Urdu/b.mp3",
                    'answer_c' => env("INAASH_API") . "vo/1/4/Urdu/c.mp3",
                    'answer_d' => "",
                ],
                "id" => [
                    'answer_a' => "",
                    'answer_b' => env("INAASH_API") . "vo/1/4/Indonesian/b.mp3",
                    'answer_c' => env("INAASH_API") . "vo/1/4/Indonesian/c.mp3",
                    'answer_d' => "",
                ],
            ],
        ],
        [
            ...
            "question" => [
                ...
                "fil" => "Mukhang siya ay may matinding sakit ng ulo at pagtaas ng tibok ng puso. Ano ang gagawin mo?",
                "fr" => "Il semble souffrir d'un mal de tête sévère et d'un rythme cardiaque accru. Que ferez-vous?",
                "ur" => "ایسا لگتا ہے کہ اسے شدید سر درد اور دل کی دھڑکن میں اضافہ ہے۔ آپ کیا کریں گے؟",
            ...
            "answers_a" => [
                ...
                "fil" => "Tulungan siyang lumipat sa isang tahimik na lugar at sukatin ang presyon ng dugo.",
                "fr" => "Aidez-le à se déplacer dans un endroit calme et mesurez sa pression artérielle.",
                "ur" => "اس کی مدد کریں کہ وہ ایک خاموش جگہ پر منتقل ہو اور اس کا بلڈ پریشر ناپیں۔",
            ...
            "answers_b" => [
                ...
                "fil" => "Hikayatin siyang uminom ng mga inuming may caffeine upang maibsan ang sakit ng ulo niya.",
                "fr" => "Encouragez-le à boire des boissons contenant de la caféine pour soulager son mal de tête.",
                "ur" => "اس کی حوصلہ افزائی کریں کہ وہ اپنے سر درد کو کم کرنے کے لیے کیفین والی مشروبات پئیں۔",
            ...
            "wrong_b" => [
                ...
                "fil" => "Maaaring lumala ang mabilis na tibok ng puso, na nagpapataas ng panganib ng malubhang komplikasyon tulad ng stroke o atake sa puso. Ang tamang gawin ay tulungan siyang lumipat sa tahimik na lugar at sukatin ang presyon ng dugo.",
                ...
                "ur" => "یہ تیز دل کی دھڑکن کو مزید بگاڑ سکتا ہے، جس سے سنگین پیچیدگیوں جیسے اسٹروک یا ہارٹ اٹیک کا خطرہ بڑھ جاتا ہے۔ درست عمل یہ ہے کہ اسے ایک خاموش جگہ پر منتقل کریں اور اس کا بلڈ پریشر ناپیں۔",
            ...
            "answers_c" => [
                ...
                "fil" => "Pilitin siyang humiga nang patag sa kanyang likod.",
                "fr" => "Forcer à s'allonger à plat sur le dos.",
                "ur" => "اسے اپنی پیٹھ کے بل ہموار لیٹنے پر مجبور کریں۔",
            ...
            "wrong_c" => [
                ...
                "fil" => "Maaaring tumaas ang presyon ng dugo sa ulo, na nagpapalala ng mga sintomas tulad ng sakit ng ulo at hindi komportable. Ang tamang gawin ay tulungan siyang lumipat sa tahimik na lugar at sukatin ang presyon ng dugo.",
                ...
                "ur" => "یہ سر میں بلڈ پریشر کو بڑھا سکتا ہے، جس سے علامات جیسے سر درد اور بے سکونی مزید بڑھ جاتی ہیں۔ درست عمل یہ ہے کہ اس کی مدد کریں کہ وہ ایک خاموش جگہ پر منتقل ہو اور اس کا بلڈ پریشر ناپیں۔",
            ...
            "wrong_answer_audio_urls" => [
                "ar" => [
                    'answer_a' => "",
                    'answer_b' => env("INAASH_API") . "vo/1/5/Arabic/b.mp3",
                    'answer_c' => env("INAASH_API") . "vo/1/5/Arabic/c.mp3",
                    'answer_d' => "",
                ],
                "en" => [
                    'answer_a' => "",
                    'answer_b' => env("INAASH_API") . "vo/1/5/English/b.mp3",
                    'answer_c' => env("INAASH_API") . "vo/1/5/English/c.mp3",
                    'answer_d' => "",
                ],
                "fr" => [
                    'answer_a' => "",
                    'answer_b' => env("INAASH_API") . "vo/1/5/French/b.mp3",
                    'answer_c' => env("INAASH_API") . "vo/1/5/French/c.mp3",
                    'answer_d' => "",
                ],
                "fil" => [
                    'answer_a' => "",
                    'answer_b' => env("INAASH_API") . "vo/1/5/Filipino/b.mp3",
                    'answer_c' => env("INAASH_API") . "vo/1/5/Filipino/c.mp3",
                    'answer_d' => "",
                ],
                "ur" => [
                    'answer_a' => "",
                    'answer_b' => env("INAASH_API") . "vo/1/5/Urdu/b.mp3",
                    'answer_c' => env("INAASH_API") . "vo/1/5/Urdu/c.mp3",
                    'answer_d' => "",
                ],
                "id" => [
                    'answer_a' => "",
                    'answer_b' => env("INAASH_API") . "vo/1/5/Indonesian/b.mp3",
                    'answer_c' => env("INAASH_API") . "vo/1/5/Indonesian/c.mp3",
                    'answer_d' => "",
                ],
            ],
        ],
        ...
        [
            ...
            "question" => [
                ...
                "fil" => "Maaaring may concussion ang manlalaro. Ano ang gagawin mo?",
                "fr" => "Le joueur pourrait avoir une commotion cérébrale. Que ferez-vous?",
                "ur" => "کھلاڑی کو ممکنہ طور پر دماغی جھٹکا لگ گیا ہے۔ آپ کیا کریں گے؟",
            ...
            "answers_a" => [
                ...
                "fil" => "Suriin ang pagtugon at paghinga ng manlalaro nang hindi siya ginagalaw at tumawag sa mga serbisyong medikal na pang-emerhensya",
                "fr" => "Vérifiez la réactivité et la respiration du joueur sans le déplacer et appelez les services médicaux d'urgence",
                "ur" => "کھلاڑی کو حرکت دیے بغیر اس کی ردعمل اور سانس لینے کی جانچ کریں اور ہنگامی طبی خدمات کو کال کریں۔",
            ...
            "answers_b" => [
                ...
                "fil" => "Budburan ng tubig sa mukha ng manlalaro upang subukang gisingin siya nang mabilis.",
                "fr" => "Éclaboussez le visage du joueur avec de l'eau pour essayer de le réveiller rapidement.",
                "ur" => "کھلاڑی کے چہرے پر پانی چھڑکیں تاکہ اسے جلدی سے بیدار کرنے کی کوشش کی جا سکے۔",
            ...
            "wrong_b" => [
                ...
                "fil" => "Ang pag-spray ng tubig sa mukha ng nasugatan ay hindi ginagamot ang pinagbabatayan ng pinsala, at maaaring magdulot ng pagkaantala sa pagkuha ng kinakailangang tulong medikal, lumala ang mga sintomas, o magdulot ng pinsala. Ang tamang aksyon ay suriin ang tugon at paghinga ng manlalaro nang hindi siya ginagalaw at tumawag sa mga serbisyong medikal na pang-emergency",
                ...
                "ur" => "زخمی شخص کے چہرے پر پانی کا چھڑکاؤ چوٹ کی بنیادی وجہ کا علاج نہیں کرتا، اور ضروری طبی امداد حاصل کرنے میں تاخیر، علامات کو خراب کرنے، یا نقصان کا سبب بن سکتا ہے۔ صحیح عمل یہ ہے کہ کھلاڑی کو حرکت دیے بغیر اس کے ردعمل اور سانس لینے کو چیک کریں اور ہنگامی طبی خدمات کو کال کریں۔",
            ...
            "answers_c" => [
                ...
                "fil" => "Igalaw ang manlalaro at umupo siya upang magising siya.",
                "fr" => "Déplacez le joueur et asseyez-le pour le réveiller.",
                "ur" => "کھلاڑی کو منتقل کریں اور اسے بیدار کرنے کے لیے بٹھائیں۔",
            ...
            "wrong_c" => [
                ...
                "fil" => "Ang paglipat ng isang taong may pinsala sa ulo ay maaaring magpalala ng anumang pinsala sa gulugod o utak, o maging sanhi ng permanenteng pinsala sa ugat, na nagpapataas ng kalubhaan ng kondisyon. Ang tamang aksyon ay suriin ang tugon at paghinga ng manlalaro nang hindi siya ginagalaw at tumawag sa mga serbisyong medikal na pang-emergency",
                ...
                "ur" => "سر کی چوٹ والے شخص کو منتقل کرنے سے ریڑھ کی ہڈی یا دماغ میں کسی بھی قسم کی چوٹ بڑھ سکتی ہے، یا مستقل اعصاب کو نقصان پہنچ سکتا ہے، جس سے حالت کی سنگینی بڑھ جاتی ہے۔ صحیح عمل یہ ہے کہ کھلاڑی کو حرکت دیے بغیر اس کے ردعمل اور سانس لینے کی جانچ کی جائے اور ہنگامی طبی خدمات کو کال کریں۔",
            ...
            "wrong_answer_audio_urls" => [
                "ar" => [
                    'answer_a' => "",
                    'answer_b' => env("INAASH_API") . "vo/2/1/Arabic/b.mp3",
                    'answer_c' => env("INAASH_API") . "vo/2/1/Arabic/c.mp3",
                    'answer_d' => "",
                ],
                "en" => [
                    'answer_a' => "",
                    'answer_b' => env("INAASH_API") . "vo/2/1/English/b.mp3",
                    'answer_c' => env("INAASH_API") . "vo/2/1/English/c.mp3",
                    'answer_d' => "",
                ],
                "fr" => [
                    'answer_a' => "",
                    'answer_b' => env("INAASH_API") . "vo/2/1/French/b.mp3",
                    'answer_c' => env("INAASH_API") . "vo/2/1/French/c.mp3",
                    'answer_d' => "",
                ],
                "fil" => [
                    'answer_a' => "",
                    'answer_b' => env("INAASH_API") . "vo/2/1/Filipino/b.mp3",
                    'answer_c' => env("INAASH_API") . "vo/2/1/Filipino/c.mp3",
                    'answer_d' => "",
                ],
                "ur" => [
                    'answer_a' => "",
                    'answer_b' => env("INAASH_API") . "vo/2/1/Urdu/b.mp3",
                    'answer_c' => env("INAASH_API") . "vo/2/1/Urdu/c.mp3",
                    'answer_d' => "",
                ],
                "id" => [
                    'answer_a' => "",
                    'answer_b' => env("INAASH_API") . "vo/2/1/Indonesian/b.mp3",
                    'answer_c' => env("INAASH_API") . "vo/2/1/Indonesian/c.mp3",
                    'answer_d' => "",
                ],
            ],
        ],
        [
            ...
            "question" => [
                ...
                "fil" => "Maaaring may nabasag na tuhod ang manlalaro. Ano ang gagawin mo?",
                "fr" => "Le coureur peut avoir une genou cassée. Que ferez-vous?",
                "ur" => "ایسا لگتا ہے کہ بھاگنے والے نے اپنا گھٹنا توڑ دیا آپ کیا کریں گے؟",
            ...
            "answers_a" => [
                ...
                "fil" => "Patatagin ang tuhod at tumawag para sa serbisyong medikal na emergency",
                "fr" => "Stabilisez le genou et appelez les secours médicaux",
                "ur" => "گھٹنے کو مستحکم کریں اور سروس میڈیکل ایمرجنسی کو کال کریں۔",
            ...
            "answers_b" => [
                ...
                "fil" => "Hikayatin ang manlalaro na tumayo at subukang maglakad upang mailipat ang tuhod at mabawasan ang sakit.",
                "fr" => "Encouragez le coureur à se lever et à essayer de marcher pour bouger la genou et soulager la douleur.",
                "ur" => "رنر کو کھڑے ہونے کی ترغیب دیں اور گھٹنے کو حرکت دینے اور درد کو دور کرنے کے لیے چلنے کی کوشش کریں۔",
            ...
            "wrong_b" => [
                ...
                "fil" => "Magdudulot ito ng paglala ng injury at magpapalala sa bali, na maaaring mangailangan ng mas kumplikadong surgical intervention. Ang tamang hakbang ay i-stabilize ang tuhod at humingi ng tulong mula sa mga serbisyong medikal ng emerhensiya",
                ...
                "ur" => "اس کی وجہ سے چوٹ مزید بگڑ جائے گی اور فریکچر غیر مستحکم ہو جائے گا، جس کے نتیجے میں زیادہ پیچیدہ سرجیکل مداخلت کی ضرورت پڑ سکتی ہے۔ صحیح اقدام یہ ہے کہ گھٹنے کو مستحکم کریں اور ہنگامی طبی خدمات سے مدد طلب کریں۔",
            ...
            "answers_c" => [
                ...
                "fil" => "Subukang ilipat ang tuhod nang malumanay upang matukoy ang kalubhaan ng pinsala",
                "fr" => "Essayez de bouger doucement le genou pour déterminer la gravité de la blessure",
                "ur" => "چوٹ کی شدت کا تعین کرنے کے لیے گھٹنے کو آہستہ سے حرکت دینے کی کوشش کریں۔",
            ...
            "wrong_c" => [
                ...
                "fil" => "Magdudulot ito ng paglala ng bali at pagkapunit ng mga tissue o ligaments sa palibot ng tuhod, na magdudulot ng malubhang komplikasyon. Ang tamang hakbang ay i-stabilize ang tuhod at humingi ng tulong mula sa mga serbisyong medikal ng emerhensiya",
                ...
                "ur" => "اس کی وجہ سے فریکچر کی شدت بڑھ جائے گی اور گھٹنے کے ارد گرد کے بافتوں یا میں ٹوٹ پھوٹ ہو سکتی ہے، جس سے سنگین پیچیدگیاں پیدا ہو سکتی ہیں۔ صحیح اقدام یہ ہے کہ گھٹنے کو مستحکم کریں اور ہنگامی طبی خدمات سے مدد طلب کریں۔",
            ...
            "wrong_answer_audio_urls" => [
                "ar" => [
                    'answer_a' => "",
                    'answer_b' => env("INAASH_API") . "vo/2/2/Arabic/b.mp3",
                    'answer_c' => env("INAASH_API") . "vo/2/2/Arabic/c.mp3",
                    'answer_d' => "",
                ],
                "en" => [
                    'answer_a' => "",
                    'answer_b' => env("INAASH_API") . "vo/2/2/English/b.mp3",
                    'answer_c' => env("INAASH_API") . "vo/2/2/English/c.mp3",
                    'answer_d' => "",
                ],
                "fr" => [
                    'answer_a' => "",
                    'answer_b' => env("INAASH_API") . "vo/2/2/French/b.mp3",
                    'answer_c' => env("INAASH_API") . "vo/2/2/French/c.mp3",
                    'answer_d' => "",
                ],
                "fil" => [
                    'answer_a' => "",
                    'answer_b' => env("INAASH_API") . "vo/2/2/Filipino/b.mp3",
                    'answer_c' => env("INAASH_API") . "vo/2/2/Filipino/c.mp3",
                    'answer_d' => "",
                ],
                "ur" => [
                    'answer_a' => "",
                    'answer_b' => env("INAASH_API") . "vo/2/2/Urdu/b.mp3",
                    'answer_c' => env("INAASH_API") . "vo/2/2/Urdu/c.mp3",
                    'answer_d' => "",
                ],
                "id" => [
                    'answer_a' => "",
                    'answer_b' => env("INAASH_API") . "vo/2/2/Indonesian/b.mp3",
                    'answer_c' => env("INAASH_API") . "vo/2/2/Indonesian/c.mp3",
                    'answer_d' => "",
                ],
            ],
        ],
        [
            ...
            "question" => [
                ...
                "fil" => "Mukhang ang manlalaro ay nakakaranas ng pinsala sa pagdila sa kanyang dila (pagpapahinga ng kalamnan ng dila). Ano ang gagawin mo?",
                ...
                "ur" => "ایسا لگتا ہے کہ کھلاڑی کی زبان نگلنے کی چوٹ ہوئی ہے (زبان کے پٹھوں کا آرام)۔ آپ کیا کریں گے؟",
            ...
            "answers_a" => [
                ...
                "fil" => "I-stabilize ang ulo ng sugatang tao at itaas ang panga.",
                "fr" => "Stabilisez la tête de la personne blessée et soulevez la mâchoire.",
                "ur" => "زخمی کی گردن کو مستحکم کریں اور جبڑے کو اوپر کریں۔",
            ...
            "answers_b" => [
                ...
                "fil" => "Subukan na pilitin ang manlalaro na umupo o tumayo upang makuha muli ang hininga.",
                "fr" => "Essayez de forcer le joueur à s'asseoir ou à se lever pour récupérer son souffle.",
                "ur" => "کھلاڑی کو بیٹھنے یا کھڑے ہونے پر مجبور کرنے کی کوشش کریں تاکہ وہ دوبارہ سانس لے سکے۔",
            ...
            "wrong_b" => [
                ...
                "fil" => "Ang paggalaw ng taong nasugatan nang hindi inaaksyunan ang bara sa daanan ng hangin ay maaaring magpalala ng kondisyon, lalo na kung siya ay walang malay, na maaaring magdulot ng kumpletong pagkawala ng paghinga at cardiac arrest. Ang tamang aksyon ay ayusin ang ulo ng nasaktan at itaas ang panga.",
                ...
                "ur" => "چوٹ لگنے والے شخص کو ایئر وے کی رکاوٹ کے بغیر منتقل کرنا حالت کو بگاڑ سکتا ہے، خاص طور پر اگر وہ بے ہوش ہو، جس سے سانس لینے کی مکمل کمی اور دل کا دورہ پڑ سکتا ہے۔ صحیح عمل یہ ہے کہ زخمی شخص کے سر کو مستحکم کریں اور جبڑے کو اٹھائیں۔",
            ...
            "answers_c" => [
                ...
                "fil" => "Subukan na hilahin ang dila gamit ang anumang nakalapit na tool, tulad ng kutsara o ballpen.",
                "fr" => "Essayez de tirer la langue avec force en utilisant tout outil à proximité, comme une cuillère ou un stylo.",
                "ur" => "کسی بھی قریبی اوزار جیسے چمچ یا قلم کا استعمال کرتے ہوئے زبان کو زبردستی کھینچنے کی کوشش کریں۔",
            ...
            "wrong_c" => [
                ...
                "fil" => "Maaaring magdulot ito ng pinsala sa bibig o lalamunan dahil sa paggamit ng hindi tamang mga kagamitan, o magpataas ng panganib ng kumpletong pagsasara ng daanan ng hangin sa hindi sinasadyang pagtulak ng dila o kagamitan. Ang tamang aksyon ay ayusin ang ulo ng nasaktan at itaas ang panga.",
                ...
                "ur" => "یہ منہ یا گلے میں چوٹ کا سبب بن سکتا ہے کیونکہ غیر مناسب اوزار کا استعمال کیا گیا ہو، یا زبان یا اوزار کو غیر ارادی طور پر دھکیلنے کی وجہ سے ایئر وے کو مکمل طور پر بند ہونے کا خطرہ بڑھا سکتا ہے۔ درست عمل یہ ہے کہ زخمی شخص کے سر کو مستحکم کریں اور جبڑے کو اٹھائیں۔",
            ...
            "wrong_answer_audio_urls" => [
                "ar" => [
                    'answer_a' => "",
                    'answer_b' => env("INAASH_API") . "vo/2/3/Arabic/b.mp3",
                    'answer_c' => env("INAASH_API") . "vo/2/3/Arabic/c.mp3",
                    'answer_d' => "",
                ],
                "en" => [
                    'answer_a' => "",
                    'answer_b' => env("INAASH_API") . "vo/2/3/English/b.mp3",
                    'answer_c' => env("INAASH_API") . "vo/2/3/English/c.mp3",
                    'answer_d' => "",
                ],
                "fr" => [
                    'answer_a' => "",
                    'answer_b' => env("INAASH_API") . "vo/2/3/French/b.mp3",
                    'answer_c' => env("INAASH_API") . "vo/2/3/French/c.mp3",
                    'answer_d' => "",
                ],
                "fil" => [
                    'answer_a' => "",
                    'answer_b' => env("INAASH_API") . "vo/2/3/Filipino/b.mp3",
                    'answer_c' => env("INAASH_API") . "vo/2/3/Filipino/c.mp3",
                    'answer_d' => "",
                ],
                "ur" => [
                    'answer_a' => "",
                    'answer_b' => env("INAASH_API") . "vo/2/3/Urdu/b.mp3",
                    'answer_c' => env("INAASH_API") . "vo/2/3/Urdu/c.mp3",
                    'answer_d' => "",
                ],
                "id" => [
                    'answer_a' => "",
                    'answer_b' => env("INAASH_API") . "vo/2/3/Indonesian/b.mp3",
                    'answer_c' => env("INAASH_API") . "vo/2/3/Indonesian/c.mp3",
                    'answer_d' => "",
                ],
            ],
        ],
        [
            ...
            "question" => [
                ...
                "fil" => "Ang manlalakbay ay nakakaranas ng pananakit sa dibdib at mawawalan ng malay. Ano ang gagawin mo?",
                "fr" => "Le coureur ressent une douleur à la poitrine et va perdre connaissance. Que ferez-vous?",
                "ur" => "دوران کرنے والا سینے میں درد محسوس کر رہا ہے اور بے ہوش ہو جائے گا۔ آپ کیا کریں گے؟",
            ...
            "answers_a" => [
                ...
                "fil" => "Suriin ang paghinga at pagtugon ng manlalaro at humingi ng tulong mula sa mga pang-emerhensiyang serbisyong medikal",
                "fr" => "Vérifiez la respiration et la réactivité du joueur et demandez l’aide des services médicaux d’urgence",
                "ur" => "کھلاڑی کی سانس لینے اور ردعمل کی جانچ کریں اور ہنگامی طبی خدمات سے مدد لیں۔",
            ...
            "answers_b" => [
                ...
                "fil" => "Bigyan siya ng tubig o inuming pampalakasan upang matulungan siyang makaramdam nang mas mabuti.",
                "fr" => "Donnez-lui de l'eau ou une boisson sportive pour l'aider à se sentir mieux.",
                "ur" => "اسے پانی یا اسپورٹس ڈرنک دیں تاکہ وہ بہتر محسوس کر سکے۔",
            ...
            "wrong_b" => [
                ...
                "fil" => "Nagiging sanhi ito ng pagbara sa daanan ng hangin na nagpapataas ng panganib ng kamatayan kung hindi maayos na mamagitan, ang tamang aksyon ay suriin ang paghinga at pagtugon at tawagan kaagad ang mga serbisyong medikal na pang-emergency",
                ...
                "ur" => "یہ ہوا کے راستے میں رکاوٹ کا باعث بنتا ہے جس سے موت کا خطرہ بڑھ جاتا ہے اگر مناسب طریقے سے مداخلت نہ کی جائے، صحیح عمل یہ ہے کہ سانس لینے اور ردعمل کی جانچ کریں اور ہنگامی طبی خدمات کو فوری طور پر کال کریں۔",
            ...
            "answers_c" => [
                ...
                "fil" => "Subukan na gisingin ang runner sa pamamagitan ng pagplash ng tubig sa kanyang mukha o mahinang pagyugyog.",
                "fr" => "Essayez de réveiller le coureur en éclaboussant d'eau sur son visage ou en le secouant vigoureusement.",
                "ur" => "کھلاڑی کو بیدار کرنے کے لیے اس کے چہرے پر پانی چھڑکیں یا زور سے ہلائیں۔",
            ...
            "wrong_c" => [
                ...
                "fil" => "Nag-aaksaya ito ng oras na maaaring magligtas ng kanyang buhay at maaaring maging sanhi ng paglala ng kondisyon kung huminto ang puso o hindi epektibo ang paghinga. Ang tamang aksyon ay suriin ang paghinga at pagtugon at tawagan kaagad ang mga serbisyong medikal na pang-emergency",
                ...
                "ur" => "اس سے وقت ضائع ہوتا ہے جو اس کی جان بچا سکتا ہے اور اگر دل بند ہو جائے یا سانس لینا ناکارہ ہو جائے تو حالت مزید خراب ہو سکتی ہے۔ صحیح عمل سانس لینے اور ردعمل کی جانچ کرنا اور ہنگامی طبی خدمات کو فوری طور پر کال کرنا ہے۔",
            ...
            "wrong_answer_audio_urls" => [
                "ar" => [
                    'answer_a' => "",
                    'answer_b' => env("INAASH_API") . "vo/2/4/Arabic/b.mp3",
                    'answer_c' => env("INAASH_API") . "vo/2/4/Arabic/c.mp3",
                    'answer_d' => "",
                ],
                "en" => [
                    'answer_a' => "",
                    'answer_b' => env("INAASH_API") . "vo/2/4/English/b.mp3",
                    'answer_c' => env("INAASH_API") . "vo/2/4/English/c.mp3",
                    'answer_d' => "",
                ],
                "fr" => [
                    'answer_a' => "",
                    'answer_b' => env("INAASH_API") . "vo/2/4/French/b.mp3",
                    'answer_c' => env("INAASH_API") . "vo/2/4/French/c.mp3",
                    'answer_d' => "",
                ],
                "fil" => [
                    'answer_a' => "",
                    'answer_b' => env("INAASH_API") . "vo/2/4/Filipino/b.mp3",
                    'answer_c' => env("INAASH_API") . "vo/2/4/Filipino/c.mp3",
                    'answer_d' => "",
                ],
                "ur" => [
                    'answer_a' => "",
                    'answer_b' => env("INAASH_API") . "vo/2/4/Urdu/b.mp3",
                    'answer_c' => env("INAASH_API") . "vo/2/4/Urdu/c.mp3",
                    'answer_d' => "",
                ],
                "id" => [
                    'answer_a' => "",
                    'answer_b' => env("INAASH_API") . "vo/2/4/Indonesian/b.mp3",
                    'answer_c' => env("INAASH_API") . "vo/2/4/Indonesian/c.mp3",
                    'answer_d' => "",
                ],
            ],
        ],
